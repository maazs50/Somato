...
import com.example.somato.SmtApplication;
...
import static com.example.somato.network.Config.BASE_URL;
...
public class BaseRetrofitHandler<T> {
    ...
    public void setupRetrofitAndOkHttp() {
        ...
        File httpCacheDirectory = new File(SmtApplication.getsAppContext().getCacheDir(), "offlineCache");
